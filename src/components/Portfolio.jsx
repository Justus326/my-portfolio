              ...
              portfolios.map(({id, src, href1, href2}) =>(
                ...
                <div className="flex items-center justify-center">
                   <a href={href1} target="_blank" rel="noreferrer">
                    <button className="w-1/1 px-3 py-2 m-4 duration-200 hover:scale-105 bg-gray-400 rounded-2xl">Demo</button>
                   </a>

                   <a href={href2} target="_blank" rel="noreferrer">
                    <button className="w-1/1 px-3 py-2 m-4 duration-200 hover:scale-105 bg-gray-400 rounded-2xl">Code</button>
                  </a>
