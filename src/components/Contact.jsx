    ...
    p-4 text-white">
        ...
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            ...
            <div className="flex justify-center items-center">
                ...
                <form action="https://getform.io/f/b9b3610b-3e51-4813-9d2b-fe7a86adfff1" method="POST" 
                className="flex flex-col w-full md:w-1/2">
                 ...
                 <textarea name="message"placeholder="Enter your message" rows="10" className="p-4 bg-transparent
